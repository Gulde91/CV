...
tribble(
    ...
    "Writing Efficient R Code, Defensive R Programming, Anomaly Detection in R, Introduction to Git, Introduction to Python, Python for R Users, Foundations of Functional Programming with purrr.") %>% 
  detailed_entries(
    with = rolle,
