...
address: |
         ...
         | Nationalitet: Danish, Date of birth: 17/03/1991
profilepic: pic.png
...
tribble(
    ...
    "Writing Efficient R Code, Defensive R Programming, Introduction to Natural Language Processing in R, Anomaly Detection in R, Introduction to Git, Introduction to Python, Python for R Users, Foundations of Functional Programming with purrr, Intermediate Functional Programming with purrr.") %>% 
  detailed_entries(
    with = rolle,
